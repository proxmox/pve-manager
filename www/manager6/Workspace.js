                ...
                listeners: {
                    selectionchange: function (sm, selected) {
                        ...
                        me.setContent({
                            ...
                            showSearch:
                                treeNode.data.id === 'root' ||
                                Ext.isDefined(treeNode.data.groupbyid),
                            pveSelNode: treeNode,
                            workspace: me,
                            viewFilter: selview.getViewFilter(),
                        });
                        ...
                        createCT,
                        {
                            ...
                            menu: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        Ext.create('Proxmox.window.ThemeEditWindow').show();
                                    },
                                },
                                {
                                    ...
                                    handler: function () {
                                        Ext.create('Proxmox.window.LanguageEditWindow').show();
                                    },
                                },
                                '-',
                                {
