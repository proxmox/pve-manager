Ext.define('PVE.VMSummaryBase', {
    ...
    vm_command: function (cmd, params) {
        ...
        Proxmox.Utils.API2Request({
            params: params,
            url: '/nodes/' + me.nodename + '/' + me.vmtype + '/' + me.vmid + '/status/' + cmd,
            method: 'POST',
                ...
                tpl: [
                    ...
                    '</table>',
                    {
                        meminfo: function (values) {
                            ...
                            return (
                                Proxmox.Utils.format_size(values.mem || 0) +
                                ' of ' +
                        ...
                        status: function (values) {
                            return values.qmpstatus ? values.qmpstatus : values.status;
                        },
                    },
                ],
            },
    ...
    reload: function () {
        ...
        Proxmox.Utils.API2Request({
            url: '/nodes/' + me.nodename + '/' + me.vmtype + '/' + me.vmid + '/status/current',
            method: 'GET',
        ...
        Proxmox.Utils.API2Request({
            url: '/nodes/' + me.nodename + '/' + me.vmtype + '/' + me.vmid + '/config',
            method: 'GET',
            success: function (response) {
                var d = response.result.data;
        ...
        var bottom_items = [
            {
                ...
                handler: function () {
                    PVE.Workspace.gotoPage(
                        'nodes/' + me.nodename + '/' + me.vmtype + '/' + me.vmid + '/migrate',
                    );
                },
            },
        ];
        ...
        if (vm_status === 'running') {
            ...
            bottom_items.push({
                ...
                handler: function () {
                    ...
                    PVE.Utils.openConsoleWindow('html5', vmtype, me.vmid, me.nodename);
                },
            });
            ...
            if (data.spice || me.vmtype === 'lxc') {
                bottom_items.push({
                    ...
                    handler: function () {
                        var vmtype = me.vmtype === 'qemu' ? 'kvm' : me.vmtype;
                        PVE.Utils.openConsoleWindow('vv', vmtype, me.vmid, me.nodename);
                    },
                });
            }
